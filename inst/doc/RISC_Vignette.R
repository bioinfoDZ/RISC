...
## -----------------------------------------------------------------------------
sce1 = readscdata(count = mat1, cell = coldata1, gene = data.frame(Symbol = rownames(mat1), row.names = rownames(mat1)), is.filter = FALSE)
sce2 = readscdata(count = mat2, cell = coldata2, gene = data.frame(Symbol = rownames(mat2), row.names = rownames(mat2)), is.filter = FALSE)
sce3 = readscdata(count = mat3, cell = coldata3, gene = data.frame(Symbol = rownames(mat3), row.names = rownames(mat3)), is.filter = FALSE)
sce4 = readscdata(count = mat4, cell = coldata4, gene = data.frame(Symbol = rownames(mat4), row.names = rownames(mat4)), is.filter = FALSE)
sce5 = readscdata(count = mat5, cell = coldata5, gene = data.frame(Symbol = rownames(mat5), row.names = rownames(mat5)), is.filter = FALSE)
sce6 = readscdata(count = mat6, cell = coldata6, gene = data.frame(Symbol = rownames(mat6), row.names = rownames(mat6)), is.filter = FALSE)
...
pcr0 = scMultiIntegrate(pcr0, eigens = 8, var.gene = var.genes, align = 'OLS', npc = 10, do.fast = TRUE)
pcr0 =scUMAP(pcr0, npc = 8, use = 'PLS')
...
UMAPlot(pcr0, colFactor = 'Set0', size = 2)
UMAPlot(pcr0, colFactor = 'Group', size = 2, Colors = brewer.pal(5, "Set1"))
UMAPlot(pcr0, colFactor = 'Cluster', size = 2, Colors = brewer.pal(4, "Dark2"))
